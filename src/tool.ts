...
export abstract class FunctionTool/*<P extends Parameters>*/ implements IFunctionTool<Parameters> {
  name = this.constructor.name;

  abstract parameters: Parameters;
  abstract description: string;
  abstract call(args: Record<any, any>/*RequiredParams<P> & OptionalParams<P>*/): Promise<any>;
