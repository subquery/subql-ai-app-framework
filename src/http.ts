...
const Message = Type.Object({
  content: Type.String(),
  role: Type.Union([Type.Literal('user'), Type.Literal('system'), Type.Literal('assistant'), Type.Literal('tool')])
});
 ...
 * */
export async function http(runnerHost: RunnerHost, port: number): any {
  const app = new Hono();
